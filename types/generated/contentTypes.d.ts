...
export interface ApiFaqFaq extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    answers: Schema.Attribute.Text;
    circleColor: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiInfoBlockInfoBlock extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    infoBlock: Schema.Attribute.Component<'info-block.info-block', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiInfoSectionInfoSection extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    linkText: Schema.Attribute.Component<'linktext.link-text', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiNavbarItemNavbarItem extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    button: Schema.Attribute.Component<'button.button', false>;
    CompanyName: Schema.Attribute.Component<'company-name.company-name', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    image: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    ...
    navbar: Schema.Attribute.Component<'navbar-items.navbar-items', false>;
    pageName: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiPricingBlockPricingBlock
  extends Struct.CollectionTypeSchema {
  collectionName: 'pricing_blocks';
  info: {
    displayName: 'PricingBlock';
    pluralName: 'pricing-blocks';
    singularName: 'pricing-block';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::pricing-block.pricing-block'
    > &
      Schema.Attribute.Private;
    monthlyAmount: Schema.Attribute.String;
    priceType: Schema.Attribute.String;
    pricingItems: Schema.Attribute.JSON;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiTitleHeaderTitleHeader extends Struct.CollectionTypeSchema {
  collectionName: 'title_headers';
  info: {
    displayName: 'titleHeader';
    pluralName: 'title-headers';
    singularName: 'title-header';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiWidgetTabWidgetTab extends Struct.CollectionTypeSchema {
  collectionName: 'widget_tabs';
  info: {
    displayName: 'WidgetTab';
    pluralName: 'widget-tabs';
    singularName: 'widget-tab';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::widget-tab.widget-tab'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    tabColor: Schema.Attribute.String;
    tabContent: Schema.Attribute.JSON;
    tabHeading: Schema.Attribute.String;
    tabImage: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    tabName: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    widgetId: Schema.Attribute.Integer;
  };
}
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::pricing-block.pricing-block': ApiPricingBlockPricingBlock;
      'api::title-header.title-header': ApiTitleHeaderTitleHeader;
      'api::widget-tab.widget-tab': ApiWidgetTabWidgetTab;
